...
namespace UnityThreadingExtended
{
    ...
    public abstract class TaskBase
    {
        ...
        public bool ShouldAbort
        {
            get
            {
                return UnityThreadHelperExtended.IsWebPlayer ? UnityThreadHelperExtended.WaitOne(abortEvent, 0) : abortEvent.WaitOne(0, false); 
			}
        }
        ...
        public bool HasEnded
        {
            get 
			{
                return UnityThreadHelperExtended.IsWebPlayer ? UnityThreadHelperExtended.WaitOne(endedEvent, 0) : endedEvent.WaitOne(0, false); 
			}
        }
        ...
        public bool IsFailed
        {
            ...
            {
                //return (UnityThreadHelperExtended.IsWebPlayer ? UnityThreadHelperExtended.WaitOne(endedEvent, 0) : endedEvent.WaitOne(0, false))
                //    && (UnityThreadHelperExtended.IsWebPlayer ? UnityThreadHelperExtended.WaitOne(abortEvent, 0) : abortEvent.WaitOne(0, false));
                return HasEnded && ShouldAbort;
            }
        }
        ...
        {
            if (UnityThreadHelperExtended.IsWebPlayer)
                UnityThreadHelperExtended.WaitOne(endedEvent, TimeSpan.FromSeconds(seconds));
            else
        ...
        internal void DoInternal()
        {
            ...
            if (!ShouldAbort)
            {
                ...
                var currentThread = UnityThreadingExtended.ThreadBase.CurrentThread;
                do
                {
